...
const RevForms1 = ({formData, setFormData, show}) => {
  ...
  return (
    ...
    <Image src="/2nd.png" alt="IskolarLink Logo"  fluid style={{ marginBottom: '40px' }}/>    
        ...
        <Col>
            <Form.Group as={Row} controlId='AD002' className="mb-3 form-group-spacing">
            ...
            <Form.Group as={Row} controlId='AD004' className="mb-3 form-group-spacing">
            ...
            <Form.Group as={Row} controlId='AD006' className="mb-3 form-group-spacing">
            ...
            <Form.Group as={Row} controlId='AD008' className="mb-3 form-group-spacing">
