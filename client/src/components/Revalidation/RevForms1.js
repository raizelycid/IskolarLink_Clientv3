    ...
    <Image src="/2nd.png" alt="IskolarLink Logo"  fluid style={{ marginBottom: '40px' }}/>    
        ...
        <Col>
            ...
            <Form.Group as={Row} controlId='RD003' className="mb-3 form-group-spacing">
                ...
                <Form.Control type="file" placeholder='e.g. RD003.pdf' onChange={(e) => setFormData({...formData, RD003: e.target.files[0]})}/>
            </Form.Group>
            <Form.Group as={Row} controlId='RD005' className="mb-3 form-group-spacing">
                <Form.Label>Upload Constitution and Bylaws</Form.Label>
                <Form.Control type="file" placeholder='e.g. RD005.pdf' onChange={(e) => setFormData({...formData, RD005: e.target.files[0]})}/>
            </Form.Group>
            <Form.Group as={Row} controlId='RD007' className="mb-3 form-group-spacing">
                <Form.Label>Upload Advocacy Plan</Form.Label>
                <Form.Control type="file" placeholder='e.g. RD007.pdf' onChange={(e) => setFormData({...formData, RD007: e.target.files[0]})}/>
            </Form.Group>
            <Form.Group as={Row} controlId='RD010' className="mb-3 form-group-spacing">
                ...
                <Form.Control type="file" placeholder='e.g. RD010.pdf' onChange={(e) => setFormData({...formData, RD010: e.target.files[0]})}/>
            </Form.Group>
        </Col>
        <Col>
            ...
            <Form.Group as={Row} controlId='RD004' className="mb-3 form-group-spacing">
                ...
                <Form.Control type="file" placeholder='e.g. RD004.pdf' onChange={(e) => setFormData({...formData, RD004: e.target.files[0]})}/>
            </Form.Group>
            <Form.Group as={Row} controlId='RD006' className="mb-3 form-group-spacing">
                <Form.Label>Upload General Plan of Action</Form.Label>
                <Form.Control type="file" placeholder='e.g. RD006.pdf' onChange={(e) => setFormData({...formData, RD006: e.target.files[0]})}/>
            </Form.Group>
            <Form.Group as={Row} controlId='RD008' className="mb-3 form-group-spacing">
                ...
                <Form.Control type="file" placeholder='e.g. RD008.pdf' onChange={(e) => setFormData({...formData, RD008: e.target.files[0]})}/>
            </Form.Group>
