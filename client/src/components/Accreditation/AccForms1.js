...
const AccForms1 = ({formData, setFormData, show}) => {
  ...
  return (
    <form style={{display:show}}>
        <Row>
        <Col>
            <Form.Group as={Row} controlId='AD001' className="mb-3">
            ...
            <Form.Group as={Row} controlId='AD003' className="mb-3">
            ...
            <Form.Group as={Row} controlId='AD005' className="mb-3">
            ...
            <Form.Group as={Row} controlId='AD007' className="mb-3">
